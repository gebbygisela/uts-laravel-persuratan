        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="post" action="{{ route('users.store') }}">
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    id="username" type="text" placeholder="Masukan Username Anda .." name="username">
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="nama_petugas">Nama Petugas</label>
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="nama_petugas" type="text" placeholder="Masukan Nama Anda .." name="nama_petugas">
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="status">Status</label>
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="status" type="text" placeholder="Masukan Status Anda .." name="status">
            </div>
            <div class="mb-4">
